...
<html lang="en-US">
  ...
  <body class="size-1140">
    ...
    <header class="section background-primary text-center">
          <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Product</h1>
        </header>
    <!-- MAIN -->
    <main role="main">
      <!-- Main Carousel -->
        ...
        <div class="line">
          <div class="margin">
            ...
            <div class="s-12 m-12 l-3 margin-m-bottom">
              ...
              <form action="AK1.php" method="POST"><input type="text" name="qty" placeholder="Number of Quantity"> <input type="hidden" name="id" value="<?php echo $rs1[0]; ?>"> <input type="submit" name="submit" value="Add To cart" > </form>          
            </div>
